"""
Django settings for attendance_app_django project.
...
SECRET_KEY = 'gn)rqfveb7_2gp_^exgl5ez_hm@(j)a&bgdytpopf)_$v+f&wt'
...
ROOT_URLCONF = 'attendance_app_django.urls'
...
WSGI_APPLICATION = 'attendance_app_django.wsgi.application'
