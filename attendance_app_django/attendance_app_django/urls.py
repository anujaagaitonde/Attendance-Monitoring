"""attendance_app_django URL Configuration
...
# To host media (for profile pics) add static url patterns if in debug mode by setting MEDIA_ROOT and MEDIA_URL accordingly
if settings.DEBUG:
