...
from . import views
from .views import EventDetailView, EventListView, PastEventListView, UserEventListView, UserPastEventListView, GenerateQR

urlpatterns = [
    # path(path name, path route (view), route name)
    path('', views.get_attendance_auth, name='main-home'), # Form to enter auth hash
