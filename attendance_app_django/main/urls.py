...
from .views import (EventDetailView, EventListView, PastEventListView, 
    UserEventListView, UserPastEventListView, GenerateQR,
    StaffRegisterListView, StaffCompletedRegisterListView, EventAttendanceRecord)
...
urlpatterns = [
    ...
    path('event/<int:pk>/record/', EventAttendanceRecord.as_view(), name='event-attendance-record'), # Attendance record for each event
]